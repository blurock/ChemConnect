package info.esblurock.reaction.server.datatext;
...
import info.esblurock.reaction.server.upload.StoreTextSetUploadData;
...
public class TextToDatabaseImpl extends ServerBase implements TextToDatabase {
	...
	@Override
	public String fileAsInput(String className, String sourceType, String fileName, String text, String user,
		...
		FileSourceSpecification specInstance = fileSpecification(className, sourceType, fileName, text, user,
				upload.getFileCode(), keyword);
		// TransactionInfo info = new TransactionInfo(user, keyword, className,
		// upload.getFileCode());
	...
	private FileSourceSpecification fileSpecification(String className, String sourceType, String textName, String text,
			String user, String idCode, String keyword) throws IOException {
